    ...
    while(q--)
    {
        ...
        if (l <= r) {
            if (l == r) {
                ...
                int i1 = max(l, min(r, pos));
                int i2 = max(l, min(r, pos + 1));
                int val1=pre1[z-i1]+pre2[i1];
                int val2=pre1[z-i2]+pre2[i2];
                ans = max(val1, val2);
            }
        } else {
            ans = 0;
